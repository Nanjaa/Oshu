var Oshu = {
	...
	questSpeech: {
		...
		aliNada: "I stepped into the room and saw the intricate wooden table, with its fantastical philosophers surrounding it. It wasn't for any particular reason that I wanted to see them. I've always loved ethics and philosophy, and when I learned of the philosophers on Tyrianne, I wanted to see them. I wanted to hear the words they had to say, and take something out of it that would expand my mind and give me even more closure in my life. Seeing them was so sacred and so beautiful that I wish not to talk about it. Any words I may say about them will only dwarf their beauty and wisdom. I will never be able to express my experience at the magnitude that it happened."
	},
};
